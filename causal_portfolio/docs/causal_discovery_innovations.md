...
- Aligned obs: PC 790, VAR-LiNGAM 791
- Run UTC: `2026-06-10T23:55:00+00:00`
...
|---|:-:|:-:|:-:|:-:|
| chain_congestion → btc_return | x |  | x | no |
...
|---|---|:-:|:-:|:-:|:-:|
| btc_return → cex_dex_flow | B1 |  |  | x | no |
| btc_return → ew_return | B0 | x | x | x | **yes** |
| btc_return → liq_flow | B1 |  | x |  | no |
| btc_return → mev_pressure | B1 |  |  | x | no |
| btc_return → stable_flow | B0 | x |  | x | no |
| ew_return → btc_return | B1 | x |  | x | no |
| ew_return → cex_dex_flow | B1 |  |  | x | no |
| ew_return → funding_basis | B1 | x |  |  | no |
