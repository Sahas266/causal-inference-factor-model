...
class TestBuildCPCMDag:
    ...
    def test_node_counts_single_asset(self):
        ...
        assert summary["unobserved_shocks"] == 1
    ...
    def test_node_counts_multi_asset(self):
        ...
        assert summary["unobserved_shocks"] == 3
    ...
    def test_d_separation_assets_via_factors(self):
        """Conditioning on all factors should d-separate asset returns."""
        from networkx.algorithms.d_separation import is_d_separator
        G = build_cpcm_dag(["btc", "eth"])
        cond = set(GLOBAL_FACTORS + MACRO_FACTORS)
        assert is_d_separator(G, {"btc_return"}, {"eth_return"}, cond)
