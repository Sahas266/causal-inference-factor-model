"""Standard schema for market candle (exchange-specific OHLCV) data"""
...
class MarketCandle(BaseModel):
    """
    Standard schema for market candles (exchange-specific OHLCV).
    Represents candlestick data for specific exchange markets.
    
    CoinMetrics response fields:
    - market, time, price_open, price_close, price_high, price_low, vwap, volume, candle_usd_volume
    """
